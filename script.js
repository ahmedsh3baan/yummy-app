  ...
  switch (type) {
                    ...
                    <div class="meal position-relative overflow-hidden rounded-2 cursor-pointer">
                        <a href="#" onclick="fetchData('category', '${el.strCategory}')" class="category">
                            ...
                            <div class="mealLayer position-absolute text-center text-black p-2">
                                ...
                                <p>${el.strCategoryDescription.length > 100
            ? `${el.strCategoryDescription.slice(0, 120)}...`
            : el.strCategoryDescription}</p>
                            </div>
                        </a>
                    </div>
                </div>`;
        ...
        const box = `<div class="col">
          <a href="#" onclick="fetchData('ingredient', '${el.strIngredient}')" class="ingredient" >
            ...
            <div class="text">
              ...
              <p>${el.strDescription?.length > 200
    ...
    case "meal":
      ...
      if (!data) {
        ...
        data.forEach((el) => {
          const box = `
          <div class="meal col-12 col-lg-4">
            <div class="mealLyer">
              <img src="${el.strMealThumb}" alt="${el.strMeal}" class="w-100 rounded-3"/>
          ...
          <div class="col-12 col-lg-8">
            ...
            if (el[`strIngredient${i}`]) {
              acc += `<li class="bg-primary-subtle text-dark py-1 px-2 rounded-2">${el[`strMeasure${i}`]} ${el[`strIngredient${i}`]
                }</li>`;
            }
            return acc;
          }, "")}
